...
const positions = [
  ...
  { x: 125, scale: 1, opacity: 0.9, zIndex: 2 }, // Second (moves to first)
  { x: 100, scale: 1, opacity: 0.9, zIndex: 1 }, // Third (normal stack)
  { x: 75, scale: 1, opacity: 0.9, zIndex: 0 }, // Fourth (normal stack)
];
